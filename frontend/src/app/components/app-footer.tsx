...
const socials = [
  ...
  { label: "WhatsApp", href: "https://wa.me/917518418960", icon: <WhatsAppIcon /> },
      ...
      <div className="bg-(--panel)">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 border-t border-(--line) pt-6 sm:grid-cols-2">
          ...
          <div className="flex flex-col items-start gap-2 sm:items-end sm:text-right">
            ...
            <a href="https://wa.me/917518418960" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs text-(--muted) transition-colors hover:text-(--sage)">
